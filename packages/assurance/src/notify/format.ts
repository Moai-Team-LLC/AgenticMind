...
export const formatDriftAlert = (target: string, alert: DriftAlert): AssuranceNotification => {
 ...
 */
export const formatApprovalRequest = (entry: RemediationLedgerEntry): AssuranceNotification => {
  return {
