<!--
Eval corpus fixture — vendored copy of The Agentic Product Standard v1.0
Source: https://github.com/Moai-Team-LLC/agentic-product-standard (MIT License).
Used as the grounding corpus for the eval suite (factual_retrieval /
citation_grounding cases are answerable from this text; out_of_scope cases
are deliberately outside it). Re-sync when the standard changes.
-->
